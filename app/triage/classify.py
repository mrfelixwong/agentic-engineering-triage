...
unknown or legacy labels into `general`. Be careful here: this is the seam
where a wrong rule silently mislabels a whole category. The answer key for the
verification lesson lives at `answer-keys/module-3.md`.
"""
